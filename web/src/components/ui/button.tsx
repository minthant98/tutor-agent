...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-[8px] font-sans text-[14px] font-medium transition-colors duration-[120ms] ease-[cubic-bezier(.22,.61,.36,1)] disabled:opacity-50 disabled:pointer-events-none focus-visible:outline-none",
  {
    variants: {
      variant: {
        primary:
