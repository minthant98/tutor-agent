...
>(({ className, children, variant, size, ...props }, ref) => {
  ...
  return (
    <ToggleGroupPrimitive.Item
      ref={ref}
      className={cn(
        "inline-flex items-center justify-center rounded-[8px] font-medium text-[14px] transition-all duration-[120ms] ease-[cubic-bezier(.22,.61,.36,1)] disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none",
